...
function BlogEditorForm({ post }: { post: BlogPost }) {
  ...
  const [content, setContent] = useState(getBlogEditorHtml(post.content_html || post.content_text || '<p></p>'));
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 rounded-xl border border-border/60 bg-background/50 p-3.5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select
                    className="rounded-lg border border-border/60 bg-background px-2.5 py-1 text-[11px] text-foreground outline-none transition-shadow focus:ring-1 focus:ring-primary/30"
                    value={visibility}
                ...
                <div className="flex items-center justify-between text-[12px] text-muted-foreground">
                  ...
                  <span className="inline-flex items-center gap-1">
                    ...
                    {stats.reading_time_minutes} menit
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {pendingTagNames.map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center gap-1.5 rounded-full border border-dashed border-emerald-500/30 bg-emerald-500/10 px-2.5 py-1 text-[11px] font-medium text-emerald-700 dark:text-emerald-300"
                  >
                    {tag}
                    <button
                      type="button"
              ...
              <div className="space-y-3 rounded-xl border border-border/60 bg-background/50 p-3.5">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between">
                    ...
                    <span className="tabular-nums text-[10px] text-muted-foreground/50">{excerpt.length}/160</span>
                  </div>
                  <Textarea
                    value={excerpt}
