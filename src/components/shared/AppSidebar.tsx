  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-[260px] flex-col overflow-hidden border-r border-border/50 bg-sidebar/95 backdrop-blur-xl dark:border-sidebar-border/80 dark:bg-[linear-gradient(180deg,rgba(21,27,36,0.96)_0%,rgba(17,23,31,0.98)_100%)] dark:shadow-[inset_-1px_0_0_rgba(255,255,255,0.03)]">
      ...
      <div className="flex h-16 items-center gap-3 px-5">
        ...
        <div>
          <h1 className="text-[16px] font-bold text-sidebar-foreground tracking-tight">SecondBrain</h1>
                ...
                return (
                  <div key={item.href}>
                    ...
                    >
                      ...
                      {isActive && (
                        <div
                          className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-5 rounded-full bg-primary shadow-[0_0_8px_rgba(16,185,129,0.5)] transition-all duration-200"
                        />
                      )}
        ...
        <div className="flex items-center justify-between rounded-xl bg-muted/30 p-2 shadow-sm shadow-black/5 transition-colors duration-200 hover:bg-muted/60 dark:bg-white/[0.045] dark:shadow-none dark:ring-1 dark:ring-white/[0.04] dark:hover:bg-white/[0.06]">
          <div className="flex items-center gap-2.5">
            <div className="relative flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-primary to-emerald-600 text-xs font-bold text-white shadow-md shadow-primary/20">
              {initials}
              <span className="absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full bg-emerald-400 border-[1.5px] border-sidebar" />
            </div>
            <div>
              <p className="max-w-[118px] truncate text-[13px] font-semibold text-foreground leading-tight">
                {displayName}
              </p>
          ...
          <div className="flex items-center gap-1">
            <button className="relative rounded-lg p-2 transition-colors hover:bg-muted dark:hover:bg-white/[0.07]">
              ...
              <span className="absolute top-1 right-1 h-2 w-2 rounded-full bg-red-500 shadow-[0_0_6px_rgba(239,68,68,0.5)]" />
            </button>
            <ThemeToggle />
          </div>
        </div>
