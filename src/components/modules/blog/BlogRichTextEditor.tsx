  ...
  return (
    <div className={cn('space-y-3', className)}>
      ...
      <div
        ...
        className="min-h-[320px] rounded-2xl border border-border/60 bg-background/60 px-4 py-3 text-[15px] leading-[1.75] text-foreground outline-none focus:border-primary/40 focus:ring-1 focus:ring-primary/20 sm:min-h-[420px] sm:px-5 sm:py-4 sm:text-[16px] [&_blockquote]:my-4 [&_blockquote]:border-l-4 [&_blockquote]:border-primary/40 [&_blockquote]:bg-muted/30 [&_blockquote]:px-4 [&_blockquote]:py-2 [&_blockquote]:italic [&_h1]:mt-6 [&_h1]:text-[1.75rem] [&_h1]:font-bold sm:[&_h1]:text-[2rem] [&_h2]:mt-5 [&_h2]:text-[1.35rem] [&_h2]:font-semibold sm:[&_h2]:text-[1.5rem] [&_img]:my-4 [&_img]:max-h-[420px] [&_img]:rounded-xl [&_img]:border [&_img]:border-border/60 [&_img]:object-contain [&_img]:shadow-sm [&_ol]:my-4 [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:my-2 [&_p]:min-h-[1.45em] [&_p]:text-foreground [&_p:has(br:only-child)]:my-1 [&_ul]:my-4 [&_ul]:list-disc [&_ul]:pl-6"
      />
